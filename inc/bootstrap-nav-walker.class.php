...
/**
 * Class Name: CUAR_BootstrapNavWalker
 * Description: A custom WordPress nav walker class to implement the Bootstrap 3 navigation style in a custom theme using the WordPress built in menu manager.
 * Version: 1.0.0
 */

if ( !class_exists( 'CUAR_BootstrapNavWalker' ) ) :

class CUAR_BootstrapNavWalker extends Walker_Nav_Menu {
	...
	public static function fallback( $args ) {
		if ( current_user_can( 'manage_options' ) ) {
			...
			$fb_output .= '>';
			$fb_output .= '<li><a href="' . admin_url( 'nav-menus.php' ) . '">' . __( 'Add a menu', 'cuar' ) . '</a></li>';
			$fb_output .= '</ul>';
