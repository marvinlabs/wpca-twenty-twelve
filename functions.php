...
add_action( 'after_setup_theme', 'wpcatt_setup' );
...
function wpcatt_scripts_styles() {
	...
	wp_enqueue_script( 'wpcatt-navigation', get_template_directory_uri() . '/js/navigation.js', array( 'jquery' ), '20140711', true );
	...
	wp_enqueue_style( 'wpcatt-style', get_stylesheet_uri() );

	// Loads the Internet Explorer specific stylesheet.
	wp_enqueue_style( 'wpcatt-ie', get_template_directory_uri() . '/css/ie.css', array( 'wpcatt-style' ), '20121010' );
	$wp_styles->add_data( 'wpcatt-ie', 'conditional', 'lt IE 9' );
}
add_action( 'wp_enqueue_scripts', 'wpcatt_scripts_styles' );
 ...
 */
function wpcatt_mce_css( $mce_css ) {
	$font_url = wpcatt_get_font_url();
...
add_filter( 'mce_css', 'wpcatt_mce_css' );
 ...
 */
function wpcatt_wp_title( $title, $sep ) {
	global $paged, $page;
...
add_filter( 'wp_title', 'wpcatt_wp_title', 10, 2 );
...
add_filter( 'wp_page_menu_args', 'wpcatt_page_menu_args' );
...
add_action( 'widgets_init', 'wpcatt_widgets_init' );

if ( ! function_exists( 'wpcatt_content_nav' ) ) :
/**
...
if ( ! function_exists( 'wpcatt_comment' ) ) :
/**
 * Template for comments and pingbacks.
 *
 * To override this walker in a child theme without modifying the comments template
 * simply create your own wpcatt_comment(), and that function will be used instead.
 *
...
if ( ! function_exists( 'wpcatt_entry_meta' ) ) :
/**
 ...
 */
function wpcatt_body_class( $classes ) {
	...
	if ( wp_style_is( 'wpcatt-fonts', 'queue' ) )
...
add_filter( 'body_class', 'wpcatt_body_class' );
...
add_action( 'template_redirect', 'wpcatt_content_width' );
 ...
 */
function wpcatt_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
}
add_action( 'customize_register', 'wpcatt_customize_register' );
...
add_action( 'customize_preview_init', 'wpcatt_customize_preview_js' );

/* BEGIN WPCA CHANGES */
include('inc/functions-wpca.php');
/* END WPCA CHANGES */